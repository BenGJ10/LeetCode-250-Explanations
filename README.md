...
| [1901. Find a Peak Element II](./Binary%20Search/1901.%20Find%20a%20Peak%20Element%20II.md) | Find a peak element in a 2D grid, where a peak is defined as an
...
| [61. Rotate List](./Linked%20Lists/61.%20Rotate%20List.md) | Rotate a linked list to the right by `k` places. |
| [138. Copy List with Random Pointer](./Linked%20Lists/138.%20Copy%20List%20with%20Random%20Pointer.md) | Create a `deep copy` of a linked list where each node has an additional random pointer. |
| [142. Linked List Cycle II](./Linked%20Lists/142.%20Linked%20List%20Cycle%20II.md) | Determine if a linked list has a `cycle` and return the node where the cycle begins. |
...
| [155. Min Stack](./Stacks/155.%20Min%20Stack.md) | Design a stack that supports push, pop, top, and retrieving the minimum element in constant time. |
| [239. Sliding Window Maximum](./Stacks/239.%20Sliding%20Window%20Maximum.md) | Find the maximum value in each sliding window of size k in an array. |
...
| [51. N-Queens](./Recursion/51.%20N-Queens.md) | We have to find all distinct solutions to the n-queens puzzle. |
| [77. Combinations](./Recursion/77.%20Combinations.md) | We have to find all the combinations of `k numbers` from 1 to n. |
| [79. Word Search](./Recursion/79.%20Word%20Search.md) | Determine if a word exists in a 2D grid of characters. |
| [90. Subsets II](./Recursion/90.%20Subsets%20II.md) | Find all possible subsets of a given set of integers, including duplicates. |
| [216. Combination Sum III](./Recursion/216.%20Combination%20Sum%20III.md) | Find all possible combinations of `k numbers` that add up to a target sum, using numbers from 1 to 9. |
...
| [103. Binary Tree Zigzag Level Order Traversal](./Binary%20Trees/103.%20Binary%20Tree%20Zigzag%20Level%20Order%20Traversal.md) | Perform a `zigzag level order` traversal of a binary tree and return the values. |
| [124. Binary Tree Maximum Path Sum](./Binary%20Trees/124.%20Binary%20Tree%20Maximum%20Path%20Sum.md) | Find the maximum path sum in a binary tree, where a path can start and end at any node. |
...
| [236. Lowest Common Ancestor of a Binary Tree](./Binary%20Trees/236.%20Lowest%20Common%20Ancestor.md) | Find the lowest common ancestor of two nodes in a binary tree. |
...
| [44. Wildcard Matching](./Dynamic%20Programming/44.%20Wildcard%20Matching.md) | We have to determine if a string matches a given pattern with wildcard characters. |
